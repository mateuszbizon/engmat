...
// Variable: GET_ALL_BLOGS_ASC_QUERY
// Query: *[_type == "post"] | order(publishedAt asc) {        _id, publishedAt, title, slug, categories[]->, mainImage    }
export type GET_ALL_BLOGS_ASC_QUERYResult = Array<{
  _id: string;
  publishedAt: string | null;
  title: string | null;
  slug: Slug | null;
...
// Variable: GET_BLOGS_BY_CATEGORY_SLUG_QUERY
// Query: *[_type == "post" && count(categories[@->slug.current == $categorySlug]) > 0] | order(publishedAt desc) {        _id, publishedAt, title, slug, categories[]->, mainImage    }
export type GET_BLOGS_BY_CATEGORY_SLUG_QUERYResult = Array<{
  _id: string;
  publishedAt: string | null;
  title: string | null;
  slug: Slug | null;
