    ...
    <section className='py-section-padding text-white text-center relative z-0'>
        ...
        <Container>
            <div className='grid lg:grid-cols-3 gap-x-5 gap-y-10'>
                ...
                <div className='flex flex-col gap-5'>
                    <span className='heading3'>+<CountUp from={0} to={20} delay={0.25} /></span>
                    <span className='bigger-text'>lat doświadczenia</span>
                </div>
                <div className='flex flex-col gap-5'>
                    <span className='heading3'>+<CountUp from={0} to={200} delay={0.25} /></span>
                    <span className='bigger-text'>uczniów rocznie</span>
                </div>
            </div>
        </Container>
    </section>
